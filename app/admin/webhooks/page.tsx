...
export default function WebhooksPage() {
  ...
  const handleCopyEventId = async () => {
    ...
    try {
      ...
      setCopiedId('eventId')
      setTimeout(() => setCopiedId(null), 2000)
      showToast('Event ID copiado!', 'success')
    } catch {
      showToast('Erro ao copiar', 'error')
    }
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Webhook Unificado</h1>
        <p className="text-gray-600">Endpoint único para importar participantes e credenciamento por evento</p>
      </div>
          ...
          {selectedEventId && (
            <div className="mt-4 p-3 bg-white rounded-lg border">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button size="sm" variant="secondary" onClick={handleCopyEventId}>
        ...
        <CardContent className="py-5">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button size="sm" onClick={handleCopyUrl} className="flex-shrink-0">
                  {copiedId === 'url' ? (
          ...
          >
            {showDocs ? (
              ...
              <><ChevronDown className="h-4 w-4" /> Ver documentação e exemplo</>
            )}
          </button>
            ...
            <div className="mt-4 space-y-4 border-t pt-4">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  <strong>Testar:</strong> Envie um POST para a URL acima com o payload.
                  Acesse via GET para ver a documentação completa:
                </p>
                <a
                  href="/api/webhooks/unified"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-sm text-blue-600 hover:text-blue-700 mt-1 font-medium"
                >
                  Abrir documentação da API <ExternalLink className="h-3 w-3" />
                </a>
              </div>
            </div>
          )}
