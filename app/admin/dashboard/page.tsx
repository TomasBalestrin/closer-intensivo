...
export default function AdminDashboard() {
  ...
  const fetchData = useCallback(async (showLoading = true) => {
    ...
    try {
      ...
      let participantsQuery = supabase.from('participants').select('id, is_opportunity, checked_in_day1, checked_in_day2, checked_in_day3, qualification, assigned_closer_id, event_id')
      ...
      if (participantsRes.error) console.error('Participants query error:', participantsRes.error)
