    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Análises e insights sobre os participantes do evento</p>
        </div>
        <span className="text-gray-500">{filtered.length} participantes {hasActiveFilters ? '(filtrados)' : ''}</span>
      </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-3 px-4 font-semibold text-gray-700">Qualificação</th>
                    ...
                    <th className="py-3 px-4 font-semibold text-gray-700 w-1/3">Distribuição</th>
                  </tr>
                </thead>
                <tbody>
                  {[
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-right py-3 px-4 font-semibold text-gray-700">Oport.</th>
                    <th className="text-right py-3 px-4 font-semibold text-gray-700">Cred.</th>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-4 font-semibold text-gray-700">Nicho</th>
                    <th className="text-right py-3 px-4 font-semibold text-gray-700">Qtd</th>
                    <th className="text-right py-3 px-4 font-semibold text-gray-700">%</th>
                    <th className="text-right py-3 px-4 font-semibold text-gray-700">Oport.</th>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-right py-3 px-4 font-semibold text-gray-700">Total no nicho</th>
