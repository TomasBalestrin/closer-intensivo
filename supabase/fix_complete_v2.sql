-- =============================================
-- SCRIPT COMPLETO V2: Corrigir estrutura e criar evento
-- Usa coluna "name" que já existe na tabela events
-- =============================================

-- 1. Adicionar colunas faltantes na tabela events (exceto name que já existe)
...
-- 8. Inserir o evento padrão (usando "name" que é NOT NULL na tabela)
